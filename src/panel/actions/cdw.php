<?php
    ...
    $sql_find = "SELECT * FROM trabajos WHERE id = '$id'";
...
<body>
    ...
    <div class="caja-login border-g">
        ...
        <div>
            ...
            <div><p><b>Realized:</b> <?php echo $realizado; ?> <a href="realizadow.php?id=<?php echo $id; ?>"><button class="boton-tareas-2"><?php echo $re; ?></button></a></p></div>
            <div><p><b>Delivered:</b> <?php echo $entregado; ?> <a href="entregadow.php?id=<?php echo $id; ?>"><button class="boton-tareas-2"><?php echo $be; ?></button></a></p></div>
            <div><p><b>On time:</b> <?php echo $plazo; ?> <a href="enplazow.php?id=<?php echo $id; ?>"><button class="boton-tareas-2"><?php echo $bp; ?></button></a></p></div>
        </div> 
    </div>

    <div style="text-align: center;"><a href="deletew.php?id=<?php echo $id; ?>"><button Class="boton-enviar-delete">Delete</button></a></div>
