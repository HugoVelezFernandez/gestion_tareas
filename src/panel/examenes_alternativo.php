            ...
            <div class="div-contenido">
                <div class="div-principal border-g">
                    ...
                    <div class="caja-mostrar-tareas">
                        ...
                        <?php
                            if(!empty($_GET['sdh']) AND $_GET['sdh'] == "on"){header('location: examenes.php');}

                            $sql_ch2 = "SELECT id FROM examenes WHERE vinc_usuario = $id_token_decode AND realizado = 'Yes'";
                            if($result = $conn->query($sql_ch2)){while($row = $result->fetch_assoc()){$contar = $contar + 1;}}

                            $sql_find_tareas = "SELECT id, asignatura, texto, dia, mes FROM examenes WHERE vinc_usuario = $id_token_decode AND realizado = 'Yes' LIMIT $inicio_mostrar_sql,$max_mostrar_sql";
                            if($result = $conn->query($sql_find_tareas)){
                    ...
                    <div class="pages">
                        <input type="checkbox" name="sdh"> Show Normal Exams
