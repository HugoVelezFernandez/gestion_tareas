<?php 
    ...
    $csmdon = 0;
    $sql_find_tareas = "SELECT id FROM tareas WHERE vinc_usuario = $id_token_decode  AND entregado = 'Yes'";
            ...
            <div class="div-contenido">
                <div class="div-principal border-g">
                    ...
                    <div class="caja-mostrar-tareas">
                        ...
                        <?php
                            if(!empty($_GET['sdh']) AND $_GET['sdh'] == "on"){header('location: tareas.php');}

                            $sql_ch2 = "SELECT id FROM tareas WHERE vinc_usuario = $id_token_decode AND entregado = 'Yes'";
                            if($result = $conn->query($sql_ch2)){while($row = $result->fetch_assoc()){$contar = $contar + 1;}}

                            $sql_find_tareas = "SELECT id, texto, dia_entrega, mes_entrega, entregado FROM tareas WHERE vinc_usuario = '$id_token_decode' AND entregado = 'Yes' LIMIT $inicio_mostrar_sql,$max_mostrar_sql";
                            if($result = $conn->query($sql_find_tareas)){
